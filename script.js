...
function addUser(){
    ...
    if(Email == em && Password == pass) {
        error.innerHTML = "<span style = 'color : green; font-size : 18px;' >Login Successful</span>"   
    }
    else {
        error.innerHTML = "<span style = 'color : red; font-size : 18px;' >Email and Password doesn't match</span>" 
    }
}
